...
#define UP_LED_NUM 168
#define DOWN_LED_NUM 195+37
#define MID_LED_NUM  50+45+40+35+30+25+15+4+8 //244
...
// static const RGB_t blue = {0, 3, 225};
// static const RGB_t off = {0, 0, 0};
// static const RGB_t dim_red = {64, 0, 0};  //靶心的颜色
// static const RGB_t dim_blue = {0, 0, 96};   //靶心的颜色
// static const RGB_t R_red = {255, 0, 0};  //R标的颜色
// static const RGB_t R_blue = {0, 0, 255};   //R标的颜色


static const RGB_t blue = {0, 0, 170};
static const RGB_t off = {0, 0, 0};

static const RGB_t dim_blue = {0, 0, 100};   //靶心的颜色
static const RGB_t R_red = {255, 0, 0};  //R标的颜色
static const RGB_t R_blue = {0, 0, 255};   //R标的颜色
...
void Led_light_circle(uint8_t circle);
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif
